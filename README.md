...
Program contains two pieces of code: main.py and SlidersC.py.

SlidersC.py is class that contains basic GUI for setting lower and upper HSV color bounderies for the mask. It also has few usefull buttons that can set red, green, blue and skin color instantly. 
